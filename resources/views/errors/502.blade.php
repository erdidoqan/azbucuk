        ...
        <div class="container">
            ...
            c6,0,10.8,4.8,10.8,10.8V147.4z"/>
              ...
              c6,0,10.8,4.8,10.8,10.8V252.5z"/>
                    ...
                    <!-- SVG shape START -->
                    <!-- Content -->
                    <h1 class="display-1 text-primary">502</h1>
                    <h2>Server Hatası Oldu!</h2>
                    <p>Ya bir şeyler ters gitti ya da bu sayfa artık mevcut değil.</p>
                    <a href="/" class="btn btn-danger-soft mt-3"><i class="fas fa-long-arrow-alt-left me-3"></i>Ana sayfaya geri dön</a>
                </div>
            </div>
        </div>
    </section>
